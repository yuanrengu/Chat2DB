...
const dyteRecordingToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);display:block}";
...
const DyteRecordingToggle = class {
        ...
        case 'IDLE':
          try {
            ...
            this.dyteAPIError.emit({
              ...
              message: this.t('Error while starting recording.'),
            });
          }
          return;
        case 'RECORDING':
          try {
            ...
            this.dyteAPIError.emit({
              ...
              message: this.t('Error while stopping recording.'),
            });
          }
          return;
        case 'STARTING':
  ...
  render() {
    if (!this.canRecord)
      return;
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('Record') }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, onClick: this.toggleRecording, icon: this.getIcon(), isLoading: this.isLoading(), label: this.t(this.getLabel()), variant: this.variant, disabled: this.disabled })));
  }
