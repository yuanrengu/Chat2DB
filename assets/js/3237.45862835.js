...
const dyteSettingsToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);display:block}";
...
const DyteSettingsToggle = class {
  ...
  toggleSettings() {
    ...
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings = !_store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSettings;
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeMoreMenu = false;
  }
  render() {
    const text = this.t('settings');
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, onClick: () => this.toggleSettings(), icon: this.iconPack.settings, label: text, variant: this.variant })));
  }
};
