...
const DytePluginsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewPlugins = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    this.canViewPlugins = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.b)(meeting);
