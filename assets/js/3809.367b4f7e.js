...
/* harmony import */ var _index_eecc1518_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24228);
...
const DyteSetupScreen = class {
  constructor(hostRef) {
    ...
    this.join = async () => {
      ...
      if (this.displayName.trim() !== '' && !this.isJoining) {
        ...
        await ((_b = this.meeting) === null || _b === void 0 ? void 0 : _b.joinRoom());
      }
    };
  ...
  render() {
    ...
    const defaults = {
      ...
      config: this.config,
      states: _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_6__.s,
      size: this.size,
      iconPack: this.iconPack,
      t: this.t,
    };
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_2__.R, { element: "dyte-participant-tile", defaults: defaults, props: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md' }, childProps: { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self, size: 'md' }, deepProps: true }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "metadata" }, this.displayName.trim() === '' ? ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, this.t('setup_screen.join_in_as'))) : ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "label" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('setup_screen.joining_as')), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_7__.s)(this.displayName, 20)))), this.canEditName && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: this.t('setup_screen.your_name'), value: this.displayName, autoFocus: true, onInput: (e) => {
        this.displayName = e.target.value;
      }, onKeyDown: (e) => {
        if (e.key === 'Enter') {
          this.join();
        }
      } })), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", onClick: this.join, disabled: disabled, iconPack: this.iconPack, t: this.t }, this.isJoining ? ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { iconPack: this.iconPack, t: this.t })) : (this.t('join')))))));
  }
