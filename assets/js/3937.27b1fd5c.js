...
const DytePermissionsMessage = class {
  constructor(hostRef) {
    ...
    this.continue = () => {
      ...
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage = { enabled: false };
    };
    this.reload = () => {
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "text-icon", icon: this.iconPack.warning, iconPack: this.iconPack, t: this.t }), isDeniedBySystem
      ? this.t(`perm_sys_denied.${(_a = _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage.kind) !== null && _a !== void 0 ? _a : 'audio'}`)
      : this.t(`perm_denied_title.${(_b = _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage.kind) !== null && _b !== void 0 ? _b : 'audio'}`)), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t(`perm_denied_text.${(_c = _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage.kind) !== null && _c !== void 0 ? _c : 'audio'}`)), isDeniedBySystem && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('perm.sys_denied.message')), !isDeniedBySystem && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("a", { class: "need-help-link", href: this.getLink((_d = _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage.kind) !== null && _d !== void 0 ? _d : 'audio'), target: "_blank", rel: "noreferrer external noreferrer noopener" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "text-icon", icon: this.iconPack.attach, iconPack: this.iconPack, t: this.t }), this.t('Need help on how to do this?'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "actions" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", variant: "secondary", onClick: this.continue, iconPack: this.iconPack, t: this.t }, this.t('Continue as it is')), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", onClick: this.reload, iconPack: this.iconPack, t: this.t }, this.t('Reload'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
