...
const DytePollsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewPolls = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.d)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting && meeting.polls) {
      ...
      this.canViewPolls = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.d)(meeting);
  ...
  togglePollsTab() {
    ...
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.pollsActive;
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pollsActive ? 'polls' : 'none';
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.unreadPollsCount !== 0 && !this.pollsActive && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count", part: "unread-count" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.unreadPollsCount <= 100 ? this.unreadPollsCount : '99+'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, class: { active: this.pollsActive }, onClick: () => this.togglePollsTab(), icon: this.iconPack.poll, label: text, variant: this.variant })));
  }
