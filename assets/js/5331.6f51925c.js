...
const dyteLeaveButtonCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);display:block}";
...
const DyteLeaveButton = class {
  constructor(hostRef) {
    ...
    this.leave = () => {
      ...
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeLeaveConfirmation = true;
    };
    this.variant = 'button';
    this.size = undefined;
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, { label: text }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, class: "leave", onClick: this.leave, icon: this.iconPack.call_end, label: text, variant: this.variant })));
  }
};
