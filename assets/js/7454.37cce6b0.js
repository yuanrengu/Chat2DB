...
class DraftStateManager {
  ...
  get allConnectedMeetings() {
    return this.currentState.meetings;
  }
  get allParticipants() {
  ...
  addNewMeeting() {
    ...
    const _a = (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.c)(), meeting = __rest(_a, ["participants"]);
  ...
  updateMeetingTitle(meetingId, newTitle) {
    ...
    if (!(0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.i)(meetingId)) {
  ...
  deleteMeeting(meetingId) {
    __classPrivateFieldSet(this, _DraftStateManager_hasLocalChanges, true, "f");
    const meeting = __classPrivateFieldGet(this, _DraftStateManager_allMeetingsMap, "f").get(meetingId);
    const participants = __classPrivateFieldGet(this, _DraftStateManager_instances, "m", _DraftStateManager_getMeetingParticipants).call(this, meeting.id).map(_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p);
    ...
    if (!(0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.i)(meeting.id)) {
  ...
  assignParticipantsRandomly() {
    const splits = (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.s)(this.unassignedParticipants, this.allConnectedMeetings.length);
  ...
  unassignAllParticipants() {
    const destinationMeetingId = __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.id;
    const customParticipantIds = this.allParticipants.map(_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p);
    return this.assignParticipantsToMeeting(customParticipantIds, destinationMeetingId);
  }
  /**
  ...
  get meetingsToCreate() {
    return this.allConnectedMeetings
      .filter((meeting) => (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.i)(meeting.id))
  ...
  get participantsToMove() {
    ...
    Array.from(__classPrivateFieldGet(this, _DraftStateManager_participantsNewMeetingMap, "f").keys()).forEach((participantId) => {
      ...
      moveMap.get(key).push(participantId);
    });
    return Array.from(moveMap.keys()).map((key) => {
      ...
      return {
        ...
        customParticipantIds: moveMap.get(key),
      };
    });
  }
  async applyChanges(meeting) {
    ...
    if (this.participantsToMove.length !== 0) {
      this.participantsToMove.forEach(({ sourceMeetingId, destinationMeetingId, customParticipantIds }) => {
        meeting.connectedMeetings.moveParticipants(sourceMeetingId, destinationMeetingId, customParticipantIds);
      });
    }
    // delete rooms
...
_DraftStateManager_hasLocalChanges = new WeakMap(), _DraftStateManager_state = new WeakMap(), _DraftStateManager_participantsNewMeetingMap = new WeakMap(), _DraftStateManager_participantsOldMeetingMap = new WeakMap(), _DraftStateManager_meetingParticipantsMap = new WeakMap(), _DraftStateManager_allParticipantsMap = new WeakMap(), _DraftStateManager_allMeetingsMap = new WeakMap(), _DraftStateManager_meetingsToUpdate = new WeakMap(), _DraftStateManager_meetingsToDelete = new WeakMap(), _DraftStateManager_instances = new WeakSet(), _DraftStateManager_init = function _DraftStateManager_init(state) {
  ...
  __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.participants.forEach((participant) => {
    __classPrivateFieldGet(this, _DraftStateManager_participantsOldMeetingMap, "f").set((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), __classPrivateFieldGet(this, _DraftStateManager_state, "f").parentMeeting.id);
  });
  __classPrivateFieldGet(this, _DraftStateManager_state, "f").meetings.forEach((meeting) => {
    meeting.participants.forEach((participant) => {
      __classPrivateFieldGet(this, _DraftStateManager_participantsOldMeetingMap, "f").set((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), meeting.id);
    });
  });
  ...
  if (__classPrivateFieldGet(this, _DraftStateManager_allParticipantsMap, "f").has((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant))) {
    return;
  }
  __classPrivateFieldGet(this, _DraftStateManager_allParticipantsMap, "f").set((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), participant);
  __classPrivateFieldGet(this, _DraftStateManager_participantsNewMeetingMap, "f").set((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant), meeting.id);
  __classPrivateFieldGet(this, _DraftStateManager_meetingParticipantsMap, "f").get(meeting.id).add((0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(participant));
...
const DyteBreakoutRoomsManager = class {
  constructor(hostRef) {
    ...
    this.enableConfirmationModal = (modalType = 'start-breakout') => {
      ...
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = { active: false };
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = activeConfirmationModal;
    };
  ...
  connectedCallback() {
    ...
    this.meeting.connectedMeetings.removeAllListeners();
    this.meeting.connectedMeetings.on('connectedMeetingState', this.updateLocalState.bind(this));
    this.meeting.connectedMeetings.on('changingMeeting', this.close.bind(this));
  ...
  disconnectedCallback() {
    ...
    this.meeting.connectedMeetings.off('connectedMeetingState', this.updateLocalState);
  ...
  updateLocalState(payload) {
    ...
    if (this.roomConfig.mode === 'create' && !this.meeting.connectedMeetings.isActive) {
      (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.r)();
    }
  ...
  onParticipantDelete(event) {
    const { detail } = event;
    const id = (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(detail);
    if (id == null)
      return;
    this.unassignParticipant(id);
  }
  ...
  async joinRoom(destinationMeetingId) {
    const participantId = (0,_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p)(this.meeting.self);
  ...
  getApproxDistribution() {
    const num = this.stateManager.unassignedParticipants.length / this.roomConfig.rooms;
  ...
  renderRoomSwitcher() {
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "room-switcher-container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.breakout_rooms }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.t('breakout_rooms.join_breakout_header'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rooms", ref: (el) => (this.selectorRef = el) }, this.renderMainRoomMaybe(), this.getPermittedRooms().map((room, idx) => {
      return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-manager", { key: room['id'], assigningParticipants: this.assigningParticipants, isDragMode: this.isDragMode, defaultExpanded: idx === 0, meeting: this.meeting, mode: this.roomConfig.mode, onDelete: () => this.onRoomDelete(room['id']), onParticipantsAdd: () => this.assignParticipantsToRoom(room['id']), onRoomJoin: () => this.joinRoom(room['id']), states: this.states, room: Object.assign({}, room), iconPack: this.iconPack, t: this.t }));
    })))));
  }
  renderLoading() {
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "loading-content" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { size: "xl" }))));
  }
  renderRoomConfig() {
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "room-config" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.breakout_rooms }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.t('breakout_rooms.room_config_header'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "create-room" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('breakout_rooms.num_of_rooms')), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-counter", { value: this.roomConfig.rooms, minValue: 1, iconPack: this.iconPack, t: this.t, onValueChange: (val) => {
        this.roomConfig = Object.assign(Object.assign({}, this.roomConfig), { rooms: Math.max(+val.detail, 1) });
      } })), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "distribution-hint" }, `${this.t('breakout_rooms.approx')}${' '}`, ' ', (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("em", null, this.getApproxDistribution(), " ", this.t('breakout_rooms.participants_per_room')), ' ', this.t('breakout_rooms.division_text')), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("footer", null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", iconPack: this.iconPack, t: this.t, size: "lg", title: this.t('create'), disabled: this.roomConfig.rooms === 0, onClick: () => this.onCreateRooms() }, this.t('create'))))));
  }
  render() {
    if (this.loading) {
    ...
    // participant config
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-config-wrapper" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-config" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { part: "menu" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, this.t('breakout_rooms.assign_participants')), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-participants", { meeting: this.meeting, iconPack: this.iconPack, t: this.t, participantIds: this.stateManager.unassignedParticipants.map(_breakout_rooms_12fe23d2_js__WEBPACK_IMPORTED_MODULE_4__.p), selectedParticipantIds: this.selectedParticipants }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('breakout_rooms.shuffle_participants'), iconPack: this.iconPack, t: this.t, slot: "shuffle-button" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { disabled: this.roomConfig.mode === 'edit' ||
        this.stateManager.unassignedParticipants.length === 0, iconPack: this.iconPack, t: this.t, kind: "button", variant: "secondary", size: "md", onClick: () => this.assignParticipantsRandomly(), class: "shuffle-button" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.shuffle, iconPack: this.iconPack, t: this.t })))), this.selectedParticipants.length !== 0 && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participants-assign-actions" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, `${this.selectedParticipants.length} ${this.t('breakout_rooms.selected')}`), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { disabled: this.roomConfig.mode === 'edit', iconPack: this.iconPack, t: this.t, kind: "button", variant: "ghost", size: "md", onClick: () => this.deselectAll(), class: "deselect-button color-danger" }, this.t('breakout_rooms.deselect'))))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "assign-rooms" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "row-header" }, this.t('breakout_rooms.rooms'), " (", this.stateManager.allConnectedMeetings.length, ")"), !this.assigningParticipants && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "cta-buttons" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", variant: "secondary", iconPack: this.iconPack, t: this.t }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { onClick: this.onAddNewRoom }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.add, iconPack: this.iconPack, t: this.t }), this.t('breakout_rooms.add_room'))), this.stateManager.allConnectedMeetings.flatMap((m) => m.participants)
      .length !== 0 && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", variant: "ghost", onClick: this.onUnassignAll, iconPack: this.iconPack, t: this.t }, this.t('breakout_rooms.unassign_all')))))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rooms", ref: (el) => (this.selectorRef = el) }, this.renderMainRoomMaybe(), this.stateManager.allConnectedMeetings.map((room, idx) => {
      return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-manager", { key: room['id'], assigningParticipants: this.assigningParticipants, isDragMode: this.isDragMode, defaultExpanded: idx === 0, meeting: this.meeting, mode: this.roomConfig.mode, onDelete: () => this.onRoomDelete(room['id']), onParticipantsAdd: () => this.assignParticipantsToRoom(room['id']), onRoomJoin: () => this.joinRoom(room['id']), onUpdate: this.onRoomUpdate, states: this.states, room: Object.assign({}, room), iconPack: this.iconPack, t: this.t }));
    })))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-config-actions" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: { 'status-bar': true, 'ephemeral-status': this.ephemeralStatusText !== '' } }, this.ephemeralStatusText !== '' && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.checkmark, iconPack: this.iconPack, t: this.t })), this.getStatusText()), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "breakout-actions" }, this.roomConfig.mode === 'create' && this.permissions.canAlterConnectedMeetings && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md", iconPack: this.iconPack, t: this.t, class: "start-breakout-button", onClick: () => this.enableConfirmationModal('start-breakout') }, this.t('breakout_rooms.start_breakout'))), this.roomConfig.mode === 'edit' &&
      this.stateManager.hasLocalChanges &&
      this.permissions.canAlterConnectedMeetings && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md", iconPack: this.iconPack, t: this.t, class: "color-danger", variant: "ghost", onClick: () => this.discardChanges() }, this.t('breakout_rooms.discard_changes'))), this.roomConfig.mode === 'edit' &&
      this.stateManager.hasLocalChanges &&
      this.permissions.canAlterConnectedMeetings && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md", iconPack: this.iconPack, t: this.t, class: "update-breakout-button", onClick: this.applyChanges }, this.t('breakout_rooms.update_breakout'))), this.roomConfig.mode === 'edit' &&
      !this.stateManager.hasLocalChanges &&
      this.permissions.canAlterConnectedMeetings && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md", iconPack: this.iconPack, t: this.t, class: "close-breakout-button", onClick: () => this.enableConfirmationModal('close-breakout') }, this.t('breakout_rooms.close_breakout'))))))));
  }
