...
const DyteParticipantsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewParticipants = (0,_sidebar_f6c4a327_js__WEBPACK_IMPORTED_MODULE_4__.a)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    this.canViewParticipants = (0,_sidebar_f6c4a327_js__WEBPACK_IMPORTED_MODULE_4__.a)(meeting);
