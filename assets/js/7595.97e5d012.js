...
const dyteCameraToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);display:block}";
...
const DyteCameraToggle = class {
  ...
  getState() {
    ...
    if (couldNotStart) {
      tooltipLabel = this.t('Unable to capture video');
    }
