...
const dyteLivestreamToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);display:block}";
...
const DyteLivestreamToggle = class {
    ...
    if (this.livestreamState === 'LIVESTREAMING') {
      try {
        ...
        this.dyteAPIError.emit({
          ...
          message: this.t('Error while stopping livestream.'),
        });
      }
    }
    else {
      try {
        ...
        this.dyteAPIError.emit({
          ...
          message: this.t('Error while starting livestream.'),
        });
      }
    }
  }
  ...
  getLivestreamLabel() {
    switch (this.livestreamState) {
      case 'IDLE':
        return this.t('Go Live');
      case 'LIVESTREAMING':
        return this.t('End Live');
      case 'STARTING':
  ...
  render() {
    if (!(0,_livestream_2f88cfb2_js__WEBPACK_IMPORTED_MODULE_3__.a)(this.meeting))
      return;
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, isLoading: this.isLoading(), class: { 'active-livestream': this.livestreamState === 'LIVESTREAMING' }, onClick: () => this.toggleLivestream(), icon: this.getLivestreamIcon(), disabled: this.isLoading(), label: this.t(this.getLivestreamLabel()), variant: this.variant })));
  }
