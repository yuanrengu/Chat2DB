...
/* harmony import */ var _sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(89140);
...
const dyteParticipantsToggleCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);position:relative;display:block}.waiting-participants-count{position:absolute;right:var(--dyte-space-3, 12px);box-sizing:border-box;padding:var(--dyte-space-0\\.5, 2px);-webkit-user-select:none;-moz-user-select:none;user-select:none;--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-brand-500, 33 96 253) / var(--tw-bg-opacity));font-size:12px;display:flex;height:var(--dyte-space-5, 20px);min-width:var(--dyte-space-5, 20px);align-items:center;justify-content:center;border-radius:9999px;z-index:1}:host([variant='horizontal']){display:flex;flex-direction:row-reverse;align-items:center}:host([variant='horizontal']) .waiting-participants-count{right:var(--dyte-space-4, 16px);top:auto}";
...
const DyteParticipantsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewParticipants = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.a)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting == null)
      return;
    this.canViewParticipants = (0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_4__.a)(meeting);
  ...
  toggleParticipantsTab() {
    ...
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.participantsActive;
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.participantsActive ? 'participants' : 'none';
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, badgeCount !== 0 && !this.participantsActive && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waiting-participants-count", part: "waiting-participants-count" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, badgeCount <= 100 ? badgeCount : '99+'))), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, t: this.t, class: { active: this.participantsActive }, onClick: () => this.toggleParticipantsTab(), icon: this.iconPack.participants, label: text, variant: this.variant })));
  }
