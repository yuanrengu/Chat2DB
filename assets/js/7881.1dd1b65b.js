...
const DytePollsToggle = class {
  constructor(hostRef) {
    ...
    this.updateCanView = () => {
      this.canViewPolls = (0,_sidebar_f6c4a327_js__WEBPACK_IMPORTED_MODULE_4__.d)(this.meeting);
    };
    this.variant = 'button';
  ...
  meetingChanged(meeting) {
    ...
    if (meeting && meeting.polls) {
      ...
      this.canViewPolls = (0,_sidebar_f6c4a327_js__WEBPACK_IMPORTED_MODULE_4__.d)(meeting);
