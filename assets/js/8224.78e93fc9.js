...
const DyteAvatar = class {
  constructor(hostRef) {
    ...
    this.getAvatar = () => {
      ...
      if (picture && picture.length > 0 && this.imageState !== 'errored') {
        return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "image-ctr" }, this.imageState === 'loading' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", { iconPack: this.iconPack, t: this.t }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: picture, class: { loaded: this.imageState === 'loaded' }, loading: "lazy", title: name, onLoad: () => (this.imageState = 'loaded'), onError: () => (this.imageState = 'errored'), part: "image" })));
      }
      const initials = (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_3__.g)(name);
      return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "initials", title: name, part: "initials" }, initials));
    };
  ...
  render() {
    return (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.getAvatar());
  }
};
