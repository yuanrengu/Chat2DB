...
/* harmony import */ var _index_eecc1518_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(55323);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_e9908d58_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_e9908d58_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_e9908d58_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const DyteMeeting = class {
  ...
  clearListeners(meeting) {
    ...
    // this.meeting?.connectedMeetings?.removeListener('changingMeeting', this.meetingChanged);
  }
  ...
  meetingChanged(meeting) {
    ...
    // meeting.connectedMeetings?.once('meetingChanged', this.meetingChanged.bind(this));
  ...
  async languageChanged(lang) {
    this.t = (0,_index_1faf994c_js__WEBPACK_IMPORTED_MODULE_2__.u)(await (0,_index_1faf994c_js__WEBPACK_IMPORTED_MODULE_2__.g)(lang));
  }
  listenState(e) {
    e.stopPropagation();
