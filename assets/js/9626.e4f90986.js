...
/* harmony import */ var _config_20a473a6_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74272);
...
/* harmony import */ var _index_eecc1518_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24228);
/* harmony import */ var _user_prefs_f52d234f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(85114);
/* harmony import */ var _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(86466);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(36677);
/* harmony import */ var _livestream_2f88cfb2_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(50528);
/* harmony import */ var _isObjectLike_b5266db7_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(49797);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_42ac57c7_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_42ac57c7_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_42ac57c7_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const dyteMeetingCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);box-sizing:border-box;display:flex;flex-direction:column;--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-background-1000, 8 8 8) / var(--tw-bg-opacity));color:rgb(var(--dyte-colors-text-900, 255 255 255 / 0.88));overflow:hidden;position:fixed;top:var(--dyte-space-0, 0px);right:var(--dyte-space-0, 0px);bottom:var(--dyte-space-0, 0px);left:var(--dyte-space-0, 0px);height:100%;width:100%}:host([mode='fill']){position:relative}";
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'joined';
    };
    this.waitlistedListener = () => {
      this.setStates({ meeting: 'waiting' });
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended', roomLeftState: state$1 });
        _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'ended';
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.roomLeftState = state$1;
    };
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        ...
        _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.activePermissionsMessage = permissionModalSettings;
      }
    };
    this.joinStateAcceptedListener = () => {
      this.setStates({ activeJoinStage: true });
      this.stateUpdate.emit({ activeJoinStage: true });
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.activeJoinStage = true;
    };
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_20a473a6_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_20a473a6_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme);
      if (this.config === _default_ui_config_6e4b8718_js__WEBPACK_IMPORTED_MODULE_4__.d) {
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings &&
        ((_a = _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
    ...
    if ((0,_livestream_2f88cfb2_js__WEBPACK_IMPORTED_MODULE_9__.i)(meeting)) {
    ...
    if (meeting.self.roomJoined) {
      ...
      if (this.showSetupScreen && this.newMeeting == null) {
        ...
        _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'setup';
      }
      else {
  ...
  initializePreferences() {
    ...
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.prefs = prefs;
  }
  handleChangingMeeting(destinationMeetingId) {
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager = Object.assign(Object.assign({}, _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager), { destinationMeetingId });
  }
  handleResize() {
  ...
  setStates(states) {
    ...
    (0,_config_20a473a6_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
  ...
  render() {
    ...
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_7__.s,
      config: this.config,
    ...
    return (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true, elementProps: elementProps });
  }
