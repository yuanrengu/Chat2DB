...
const dyteLivestreamPlayerCss = ":host{line-height:initial;font-family:var(--dyte-font-family, sans-serif);margin-left:var(--dyte-space-2, 8px);margin-right:var(--dyte-space-2, 8px);display:flex;height:100%;width:100%;border-radius:var(--dyte-border-radius-md, 8px);--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-background-900, 26 26 26) / var(--tw-bg-opacity))}.player-container{position:relative;margin:var(--dyte-space-4, 16px);display:flex;flex-grow:1;align-items:center;justify-content:center;overflow:hidden;border-radius:var(--dyte-border-radius-md, 8px)}video{height:100%;width:100%;border-radius:var(--dyte-border-radius-md, 8px);border-width:var(--dyte-border-width-none, 0);border-style:none;--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-background-1000, 8 8 8) / var(--tw-bg-opacity))}.loader{position:absolute;z-index:10;height:100%;width:100%;--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-background-900, 26 26 26) / var(--tw-bg-opacity));display:flex;flex-direction:column;align-items:center;justify-content:center}p{margin-top:var(--dyte-space-1, 4px);margin-bottom:var(--dyte-space-1, 4px);font-size:16px;color:rgb(var(--dyte-colors-text-700, 255 255 255 / 0.64))}.latency-controls{position:absolute;bottom:var(--dyte-space-4, 16px);right:var(--dyte-space-4, 16px);z-index:20;display:flex;flex-direction:row;align-items:center}.sync-live-stream{cursor:pointer;border-radius:var(--dyte-border-radius-sm, 4px);--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-brand-500, 33 96 253) / var(--tw-bg-opacity));padding-left:var(--dyte-space-2, 8px);padding-right:var(--dyte-space-2, 8px);padding-top:var(--dyte-space-1, 4px);padding-bottom:var(--dyte-space-1, 4px);font-size:12px}";
...
const DyteLivestreamPlayer = class {
  constructor(hostRef) {
    ...
    this.getLoadingState = () => {
      ...
      switch (this.livestreamState) {
        ...
        case 'STOPPING':
          ...
          break;
        case 'LIVESTREAMING':
          if (this.playerState !== _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.PLAYING) {
            loadingMessage = this.t('Livestream is starting...');
            showIcon = true;
            isLoading = true;
          }
    ...
    this.playerState = _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.IDLE;
    this.livestreamState = 'IDLE';
    this.playerError = undefined;
    this.latency = 0;
  }
  AddPlayerListeners(player = this.ivsPlayer) {
    Object.values(Object.assign(Object.assign({}, _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.d), _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P)).forEach((key) => {
      if (_livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.e.includes(key))
        return;
      player === null || player === void 0 ? void 0 : player.addEventListener(key, (event) => {
        var _a, _b;
        if (key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.IDLE ||
          key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.PLAYING ||
          key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.d.ERROR ||
          key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.READY)
          this.playerState = key;
        if (key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.d.ERROR) {
          this.playerError = event;
        }
        if (key === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.IDLE && player.isPaused()) {
          player.play();
        }
        if (this.playerState === _livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_4__.P.PLAYING &&
