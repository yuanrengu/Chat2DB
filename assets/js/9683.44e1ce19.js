...
/* harmony import */ var _index_eecc1518_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24228);
/* harmony import */ var _default_ui_config_6e4b8718_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36881);
/* harmony import */ var _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(86466);
/* harmony import */ var _sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(89140);
...
const DyteSidebar = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
    };
    this.enabledSections = ['none'];
    this.defaultSection = 'chat';
    this.meeting = undefined;
    this.states = undefined;
    this.config = _default_ui_config_6e4b8718_js__WEBPACK_IMPORTED_MODULE_4__.d;
  ...
  connectedCallback() {
    ...
    (0,_store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__.o)('sidebar', () => this.statesChanged());
  }
  ...
  statesChanged(s) {
    const states = s || _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__.s;
  ...
  viewSection(section) {
    ...
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__.s.activeSidebar = true;
    _store_2454ac74_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
  }
  updateEnabledSections(meeting = this.meeting) {
    const list = ['none'];
    if ((0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_6__.c)(meeting))
      list.push('chat');
    if ((0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_6__.a)(meeting))
      list.push('participants');
    if ((0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_6__.b)(meeting))
      list.push('plugins');
    if ((0,_sidebar_ff74b776_js__WEBPACK_IMPORTED_MODULE_6__.d)(meeting))
      list.push('polls');
  ...
  render() {
    ...
    if (((_a = this.states) === null || _a === void 0 ? void 0 : _a.activeSidebar) === false || this.tab === 'none')
      return null;
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.view === 'full-screen' && [
      (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t('About Call')),
      (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "mobile-header" }, this.filterSections(this.enabledSections).map((section) => ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { key: section, variant: "ghost", class: { active: this.tab === section }, onClick: () => this.viewSection(section), iconPack: this.iconPack, t: this.t }, this.t(section))))),
    ], (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: this.close, "aria-label": this.t('Close'), iconPack: this.iconPack, t: this.t }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss, iconPack: this.iconPack, t: this.t })), this.view !== 'full-screen' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t(this.tab)), this.tab === 'chat' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-chat", defaults: defaults }), this.tab === 'polls' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-polls", defaults: defaults }), this.tab === 'participants' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-participants", defaults: defaults }), this.tab === 'plugins' && (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_eecc1518_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-plugins", defaults: defaults })));
  }
...
const canViewParticipants = (meeting) => {
  var _a, _b;
  if ((0,_livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_0__.s)(meeting) && !((_a = meeting.self.permissions) === null || _a === void 0 ? void 0 : _a.acceptPresentRequests))
    return false;
...
const canViewPlugins = (meeting) => {
  if ((0,_livestream_a51a08c2_js__WEBPACK_IMPORTED_MODULE_0__.i)(meeting))
    return false;
