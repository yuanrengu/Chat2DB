...
const DyteStageToggle = class {
  constructor(hostRef) {
    ...
    this.stageCallback = async () => {
      ...
      if (stageStatus === 'OFF_STAGE') {
        ...
        if ((0,_livestream_2f88cfb2_js__WEBPACK_IMPORTED_MODULE_4__.c)(this.meeting)) {
  ...
  render() {
    if (!(0,_livestream_2f88cfb2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.meeting))
      return;
